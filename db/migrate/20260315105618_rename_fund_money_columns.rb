class RenameFundMoneyColumns < ActiveRecord::Migration[8.0]
  def change
    change_table :funds do |t|
      ...
      t.money_with_currency :total_fund
      t.money_with_currency :research_allocation
      t.money_with_currency :operations_expense_allocation
      t.money_with_currency :program_delivery_allocation
    end
  end
end
